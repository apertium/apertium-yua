...
pkgdatadir = $(datadir)/apertium-yua
pkgincludedir = $(includedir)/apertium-yua
pkglibdir = $(libdir)/apertium-yua
pkglibexecdir = $(libexecdir)/apertium-yua
...
CONFIG_CLEAN_FILES = apertium-yua.pc
...
am__installdirs = "$(DESTDIR)$(apertium_yuadir)" \
	"$(DESTDIR)$(pkgconfigdir)"
DATA = $(apertium_yua_DATA) $(noinst_DATA) $(pkgconfig_DATA)
am__tagged_files = $(HEADERS) $(SOURCES) $(TAGS_FILES) $(LISP)
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/apertium-yua.pc.in \
...
ACLOCAL = ${SHELL} /home/fran/source/apertium/languages/apertium-yua/missing aclocal-1.15
AMTAR = $${TAR-tar}
...
AUTOCONF = ${SHELL} /home/fran/source/apertium/languages/apertium-yua/missing autoconf
AUTOHEADER = ${SHELL} /home/fran/source/apertium/languages/apertium-yua/missing autoheader
AUTOMAKE = ${SHELL} /home/fran/source/apertium/languages/apertium-yua/missing automake-1.15
AWK = gawk
CG3_CFLAGS = -I/home/fran/local/include/
CG3_LIBS = -L/home/fran/local/lib -lcg3
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"Apertium\ Yucateco\" -DPACKAGE_TARNAME=\"apertium-yua\" -DPACKAGE_VERSION=\"0.1.0\" -DPACKAGE_STRING=\"Apertium\ Yucateco\ 0.1.0\" -DPACKAGE_BUGREPORT=\"https://github.com/apertium/apertium-yua/issues\" -DPACKAGE_URL=\"https://wiki.apertium.org/wiki/Apertium-yua\" -DPACKAGE=\"apertium-yua\" -DVERSION=\"0.1.0\"
ECHO_C = 
ECHO_N = -n
ECHO_T = 
HFSTOSPELL_CFLAGS = 
HFSTOSPELL_LIBS = 
HFST_CFLAGS = -I/home/fran/local/include/hfst/
HFST_LIBS = -L/home/fran/local/lib -lhfst
...
LIBS = 
LTLIBOBJS = 
LTTOOLBOX_CFLAGS = -I/home/fran/local/include/lttoolbox-3.5
LTTOOLBOX_LIBS = -L/home/fran/local/lib -llttoolbox3
MAKEINFO = ${SHELL} /home/fran/source/apertium/languages/apertium-yua/missing makeinfo
MKDIR_P = /bin/mkdir -p
PACKAGE = apertium-yua
PACKAGE_BUGREPORT = https://github.com/apertium/apertium-yua/issues
PACKAGE_NAME = Apertium Yucateco
PACKAGE_STRING = Apertium Yucateco 0.1.0
PACKAGE_TARNAME = apertium-yua
PACKAGE_URL = https://wiki.apertium.org/wiki/Apertium-yua
PACKAGE_VERSION = 0.1.0
PATH_SEPARATOR = :
PKG_CONFIG = /usr/bin/pkg-config
PKG_CONFIG_LIBDIR = 
PKG_CONFIG_PATH = /home/fran/local/lib/pkgconfig:/home/fran/local/share/pkgconfig:/usr/local/share/pkgconfig:/usr/local/lib/pkgconfig
REGTEST_CFLAGS = 
REGTEST_LIBS = 
SET_MAKE = 
SHELL = /bin/bash
STRIP = 
VERSION = 0.1.0
abs_builddir = /home/fran/source/apertium/languages/apertium-yua
abs_srcdir = /home/fran/source/apertium/languages/apertium-yua
abs_top_builddir = /home/fran/source/apertium/languages/apertium-yua
abs_top_srcdir = /home/fran/source/apertium/languages/apertium-yua
am__leading_dot = .
...
install_sh = ${SHELL} /home/fran/source/apertium/languages/apertium-yua/install-sh
...
###############################################################################
#
#   apertium_yua_dir: This is where the compiled binaries go
#   apertium_yua_srcdir: This is where the source files go
apertium_yuadir = $(prefix)/share/apertium/$(BASENAME)/
apertium_yua_srcdir = $(prefix)/share/apertium/$(BASENAME)/
apertium_yua_DATA = $(TARGETS_COMMON) \
	$(BASENAME).$(LANG1).lexc	\
	$(BASENAME).$(LANG1).twol	\
	$(BASENAME).$(LANG1).rlx	\
	$(BASENAME).post-$(LANG1).dix	\
...
$(am__aclocal_m4_deps):
apertium-yua.pc: $(top_builddir)/config.status $(srcdir)/apertium-yua.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
install-apertium_yuaDATA: $(apertium_yua_DATA)
	@$(NORMAL_INSTALL)
	@list='$(apertium_yua_DATA)'; test -n "$(apertium_yuadir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(apertium_yuadir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(apertium_yuadir)" || exit 1; \
	fi; \
	for p in $$list; do \
	...
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(apertium_yuadir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(apertium_yuadir)" || exit $$?; \
	done

uninstall-apertium_yuaDATA:
	@$(NORMAL_UNINSTALL)
	@list='$(apertium_yua_DATA)'; test -n "$(apertium_yuadir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(apertium_yuadir)'; $(am__uninstall_files_from_dir)
...
installdirs:
	for dir in "$(DESTDIR)$(apertium_yuadir)" "$(DESTDIR)$(pkgconfigdir)"; do \
...
install-data-am: install-apertium_yuaDATA install-data-local \
...
uninstall-am: uninstall-apertium_yuaDATA uninstall-local \
	uninstall-pkgconfigDATA
...
.PHONY: all all-am am--refresh check check-am clean clean-generic \
	...
	install install-am install-apertium_yuaDATA install-data \
